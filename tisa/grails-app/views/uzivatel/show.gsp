<html>
    <head>
        ...
        <title><g:message code="tisa.uzivatel.show"/></title>
    </head>
    <body>
        <div class="body">
            <h1><g:message code="tisa.uzivatel.show"/></h1>
                ...
                <table>
                    <tbody>
                        ...
                        <tr class="prop">
                            ...
                            <td valign="top" class="value">${uzivatel.id}</td>
                        ...
                        <tr class="prop">
                            ...
                            <td valign="top" class="value">${uzivatel.adresa}</td>
