<html>
    ...
    <body>
        <div class="body">
            <h1><g:message code="tisa.operatorka.login"/></h1>
            ...
            <g:form action="operatorka_login" method="post" >
                <div class="dialog">
                    <table>
                        <tbody>                        
                            <tr class="prop">
                                <td valign="top" class="name">
                                    <label for="misto"><g:message code="tisa.user.email" />:</label>
																...
																<td valign="top" class="value">
																		<input type="text" id="nazev" name="email" value="${fieldValue(bean:operatorka,field:'email')}"/>
                                </td>
                            </tr> 
