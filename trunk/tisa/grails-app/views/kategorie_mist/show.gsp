...
<html>
    <head>
        ...
        <title><g:message code="tisa.kategorie_mist.show"/></title>
    </head>
    <body>
        <div class="body">
            <h1><g:message code="tisa.kategorie_mist.show"/></h1>
                ...
                <table>
                    <tbody>
                        ...
                        <tr class="prop">
                            ...
                            <td valign="top" class="value">${kategorie_mist.id}</td>
                        ...
                        <tr class="prop">
                            ...
                            <td valign="top" class="value">${kategorie_mist.nazev}</td>
